    ...
    <div class="container-fluid">
      ...
      <a href=" index_user.php" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
        ...
        <div class="box-se d-flex col-8 justify-content-start my-3">
            ...
            <button type="button" class="btn btn-danger" style="margin-right: 10px;" onclick="location.href='admin_book3.php'">ทั้งหมด</button>
                ...
                <div class="col-12">
                    ...
                    ?>
                            ...
                            <div class="content-1 d-flex justify-content-start">
                                ...
                                <p class="c artist"><?php echo $rs['artist_nickname']; ?></p>
                                <p class="c day"><?php echo $rs['status']; ?></p>
                                <p class="c status"><?php echo $rs['payment_status']; ?></p>


                                <input type="button" class="detail-button" value="รายละเอียด" onclick="location.href='order_detail3_admin.php?oid=<?php echo $rs[0]; ?>'">
                            </div>
                    <?php }
                    }
                    ?>
