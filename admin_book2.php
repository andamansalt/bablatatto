    ...
    <div class="container-fluid">
      ...
      <a href=" index_user.php" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
        ...
        <div class="box-se d-flex col-8 justify-content-start my-3">
            ...
            <button type="button" class="btn btn-danger" style="margin-right: 10px;" onclick="location.href='admin_book2.php'">ทั้งหมด</button>
                    <button type="button" class="btn btn-outline-danger" style="margin-right: 10px;" onclick="location.href='admin2_book2.php'">รอดำเนินการ</button>
                ...
                <div class="col-12">
                    ...
                    ?>
                            ...
                            <div class="content-1 d-flex justify-content-start">
                                <p class="c id"><?php echo $rs[0]; ?></p>
                                <p class="c user"><?php echo $rs['username']; ?></p>
                                <p class="c day"><?php echo $rs['date']; ?></p>
                                <p class="c time"><?php echo $rs['time']; ?></p>
                                
                                <p class="c artist"><?php echo $rs['artist_nickname']; ?></p>
                                <p class="c status"><?php echo $rs['status']; ?></p>
                                <p class="c p_status"><?php echo $rs['payment_status']; ?></p>
