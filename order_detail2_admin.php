        ...
        <div id="display_item row justify-content-center">
            <table class="table">
                <div class="d-grid gap-2 d-md-flex  justify-content-md-start" align="center">
                    <a href="admin_book2.php" style="text-decoration:none;">
                    ...
                    ?>
                            ...
                            <div class="container col-xxl-8 px-4 py-5">
                                ...
                                <option value="18:00 น.">18:00 น.</option>
                                            ...
                                            <p class="lead">ไซส์ของลายสัก:<input type="text" name="size" style="border-radius: 10px; padding:5px; border:solid 1px black;" value="<?php echo $rs[4]; ?>"> 
                                            ...
                                            <p class="lead">ค่ามัดจำ:   <input type="text" name="price" style="border-radius: 10px; padding:5px; border:solid 1px black; width:25%;" value="<?php echo $rs['payment_amount']; ?>" > บาท(<?php echo $rs['payment_status']; ?>)</p> 

                                            <p class="lead">ช่าง: <?php echo $rs['artist_nickname']; ?></p>
                                            ...
                                            <button class="w-4 btn btn-lg btn-danger" style="width:120px; font-size:15px; border-radius: 25px; margin-left: 25%; margin-top:0;" type="submit" name="edit_book2" autocomplete="on">บันทึก</button>
                                            </form>  
                                    </div>
                                    <div class="col-10 col-sm-8 col-lg-6">
                                        <img src="img/<?php echo $rs['uploadpic_pic']; ?>" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="500" height="500" loading="lazy">
                                    </div>
                                    ...
                                    <!-- <button class="w-4 btn btn-lg btn-secondary" style="width:120px; font-size:15px; border-radius: 25px; margin-left: 10px; margin-top:0;" type="submit" name="edit_book2" autocomplete="on" >บันทึก</button> -->
