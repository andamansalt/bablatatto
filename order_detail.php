    ...
    <div class="container">
        ...
        <div id="display_item row justify-content-center">
            ...
            <div class="d-grid gap-2 d-md-flex  justify-content-md-start" align="center">
                    <a href="noticfication.php" style="text-decoration:none;">
            ...
            <div id="hero2" class="row flex-lg-row-reverse justify-content-center align-items-center g-5 py-5">
                <div class="col-lg-6 justify-content-center align-items-center">
                    ...
                    <p class="lead">วันที่จอง: <?php echo $rs[1]; ?></p>
                    <p class="lead">เวลาที่จอง: <?php echo $rs[2]; ?></p></p>
                    <p class="lead">ตำแหน่งที่สัก: <?php echo $rs[3]; ?></p>
                    <p class="lead">ขนาดของลายสัก: <?php echo $rs[4]; ?></p>
                    <p class="lead">รายละเอียดเพิ่มเติม: <?php echo $rs[5]; ?></p>
                    <p class="lead">ค่ามัดจำ: <?php echo $rs[8]; ?> บาท (<?php echo $rs[9]; ?>) </p>
                   
                    
                </div>
                <div class="col-10 col-sm-8 col-lg-6">
                    <img src="img/<?php echo $rs[7]; ?>" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="500" height="500" loading="lazy">
                </div>
