...
<div class="container-fluid">
    ...
    text-shadow: 3px 4px 6px #2b2b2b;">
            ...
            <div class="row justify-content-center" align="center">
                <h2 class="" style="font-size:150px; color:#184244;"><i class="fa-sharp fa-solid fa-circle-check"></i></h2>
                <h2 style="font-weight: bold; color:#184244;">ทำการจองสำเร็จ</h2>
                <p style="color:#184244;">ยินดีด้วย คุณทำการจองกับทางร้านสำเร็จแล้ว แล้วเจอกันเมื่อถึงวันนัด</p>
