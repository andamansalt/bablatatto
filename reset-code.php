                ...
                <main class="form-signin w-100 m-auto">
                    <form action="reset-code.php" method="POST" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <button class="w-100 btn btn-lg btn-secondary" style="border-radius: 25px;" type="submit" name="check-reset-otp" value="Submit">ดำเนินการต่อ</button>
                        </div>
