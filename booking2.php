        ...
        <div class="container ">
            ...
            <div class="row justify-content-start">
                ...
                <div class="col-10 d-flex justify-content-start">
                    ...
                    <button type="button" class="btn btn-danger" style="margin-right: 10px;" onclick="location.href='booking.php'">อัปโหลดภาพที่ต้องการสัก</button>
        ...
        <div class="row justify-content-center">
                ...
                <div class="col-10 row justify-content-center" id="nav" style="margin-top: 3% ;">
                    ...
                    <div class="col-sm-10" style="margin-top:2%; margin-left:-17%;">
                        ...
                        <input class="text-box" name="detail" type="text" placeholder="โปรดระบุขนาด">
                    </div>
                    ...
                    <input type="date" class="form-control" name="orderday" placeholder="วันจอง" required style="border-radius: 15px; border:solid #7A7676; height:50px; width:30%;"> -->
                </div>
                <div class="col-10 row justify-content-start" id="nav" style="margin-top: 3% ;">
                ...
                // $calendar = new Calendar('2022-11-05');

                // echo $calendar->show('2022-11-05');
                    ?>
                    ...
                    <button class="w-4 btn btn-lg btn-secondary" style="width:120px; font-size:15px; border-radius: 25px; margin-left: 10px;" type="submit" name="booking2" autocomplete="on">ดำเนินการต่อ</button>
                </div>
                </div>
