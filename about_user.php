    ...
    <div class="container-fluid">
      ...
      <a href=" index_user.php" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="about_user.php" class="nav-link px-2 link-danger">เกี่ยวกับเรา</a></li>
            </ul>
        ...
        <div id="hero1" class="row flex-lg-row-reverse justify-content-center align-items-center g-5 py-5" style="background-color: #1B1B1B; ">
            <div class="col-lg-6 " style="background-color: #1B1B1B; width:500px; height: auto;">
                ...
                <a href="https://www.facebook.com/babla.tattoostudio/"> <li class="ms-3"><i class="fa-brands fa-facebook"style="color: white;"></i></li></a>
                <a href="https://www.instagram.com/babla.tattoo/"><li class="ms-3"><i class="fa-brands fa-instagram"style="color: white;"></i></li></a>
                </ul>
