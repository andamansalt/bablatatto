    ...
    <div class="container">
        ...
        <div class="row justify-content-start">
                ...
                <div class="col-10 d-flex justify-content-start">
                    ...
                    <button type="button" class="btn btn-danger" onclick="location.href='noticfication3.php'">จ้างให้ร้านออกแบบลายสัก</button>
                </div>
            </div>
            <table class="col-sm-6 table">
                ...
                <tbody>
                    ...
                    $order = mysqli_query($conn, "SELECT order_id, date, time, order_detail, status, user_id, time_stamp FROM book_detail WHERE user_id = $customerNumber AND book_type = 3"); //เลือกข้อมูลที่ต้องการจากใน orders
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a class="btn btn-success" href="order_detail3.php?oid=<?php echo $rs['order_id']; ?>">รายละเอียด</a></td>
                            </tr>
                    <?php }
                    } ?>
                </tbody>
