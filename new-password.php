            ...
            <div class="col loginbrand">
                <main class="form-signin w-100 m-auto">
                    <form action="new-password.php" method="POST" autocomplete="off">
                        ...
                        <h1 class="h3 mb-3 fw-normal">รหัสผ่านใหม่</h1>
                        <p>กรุณาตั้งรหสัสผ่านใหม่ของท่าน</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <button class="w-100 btn btn-lg btn-secondary" style="border-radius: 25px;" type="submit" name="change-password" value="Change">ดำเนินการต่อ</button>
                        </div>
