    ...
    <div class="container">
        ...
        <div class="row justify-content-start">
                ...
                <div class="col-10 d-flex justify-content-start">
                    <button type="button" class="btn btn-danger" style="margin-right: 10px;"onclick="location.href='noticfication.php'">เลือกลายที่ร้านมี</button>
                    <button type="button" class="btn btn-outline-danger" style="margin-right: 10px;" onclick="location.href='noticfication2.php'">อัปโหลดภาพที่ต้องการสัก</button>
            ...
            <table class="col-sm-6 table">
                ...
                <tbody>
                    ...
                    $order = mysqli_query($conn, "SELECT order_id, date, time, order_detail, status, user_id, time_stamp FROM book_detail WHERE user_id = $customerNumber AND book_type = 1"); //เลือกข้อมูลที่ต้องการจากใน orders
